  ...
  return (
    <nav className="border-b border-zinc-200/50 dark:border-zinc-800/50 bg-white/70 dark:bg-zinc-950/70 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <a href="index.html" className="text-2xl font-bold text-primary tracking-tight">Omix Store</a>
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="sell.html" className="bg-primary text-white px-4 py-2 rounded-[14px] text-sm font-bold hover:bg-primary-hover transition-colors duration-200">
            Sell
          </a>
        </div>
      </div>
