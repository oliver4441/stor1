    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] safe-area-bottom">
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="flex-shrink-0">
          ...
          <p className="text-lg font-black text-[#ff385c] leading-tight">{formatKES(listing.price * quantity)}</p>
        </div>
        ...
        <div className="flex-1 flex gap-2">
          {user ? (
            <>
              ...
              <button
                onClick={onBuyNow}
                className="flex-1 flex items-center justify-center gap-1.5 bg-[#ff385c] text-white font-bold py-3 rounded-xl text-sm active:scale-95 transition-transform"
              >
                Buy Now
              </button>
            </>
            ...
            <>
              <a
                ...
                className="flex-1 flex items-center justify-center gap-1.5 bg-[#ff385c] text-white font-bold py-3 rounded-xl text-sm text-center"
              >
                Sign Up to Buy
              </a>
              <a
