  ...
  return (
    <>
      ...
      >
        ...
        {cartCount > 0 && (
          <span className={`absolute -top-1 -right-1 w-5 h-5 text-white text-[10px] font-bold rounded-full flex items-center justify-center transition-all duration-300 ${bump ? 'scale-125' : 'scale-100'} bg-[#ff385c]`}>
