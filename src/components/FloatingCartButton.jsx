  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-[220px] right-4 sm:bottom-[220px] sm:right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-all duration-300 bg-zinc-900 dark:bg-white ${bump ? 'animate-bounce-once' : ''}`}
        style={{ 
          bottom: position.y, 
          right: position.x, 
      ...
      >
        ...
        {cartCount > 0 && (
          <span className={`absolute -top-1 -right-1 w-5 h-5 text-white text-[10px] font-bold rounded-full flex items-center justify-center transition-all duration-300 ${bump ? 'scale-125' : 'scale-100'} bg-emerald-400 text-black`}>
      ...
      {cartOpen && (
        <>
          ...
          <div className="fixed bottom-[288px] right-4 sm:bottom-[292px] sm:right-6 w-[calc(100%-2rem)] sm:w-[380px] bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-800 z-50 overflow-hidden">
