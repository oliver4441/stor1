 ...
 * Opens WhatsApp with a pre-filled message about the listing/wish
 */
export function WhatsAppShareButton({ title, url, price, type = 'listing', className = '' }) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 bg-[#25D366] text-white font-bold py-2.5 px-4 rounded-xl hover:bg-[#20BD5A] transition-all text-sm ${className}`}
    >
 ...
 * Opens WhatsApp directly to a specific phone number
 */
export function WhatsAppChatButton({ phone, message, className = '' }) {
  if (!phone) return null;

  // Clean phone number -- remove spaces, dashes, ensure +254 format
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`inline-flex items-center gap-2 bg-[#25D366] text-white font-bold py-3 px-5 rounded-xl hover:bg-[#20BD5A] transition-all ${className}`}
    >
...
/**
 * Floating WhatsApp Button for the PDP (Product Details Page)
...
export function FloatingWhatsAppButton({ title, price, url, listingId }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`fixed bottom-24 right-4 z-50 flex items-center gap-2 bg-[#25D366] text-white font-bold py-3 px-4 rounded-full shadow-lg hover:bg-[#20BD5A] transition-all duration-300 hover:scale-105 ${
 ...
 * A clean icon button for the navbar. Links to the store's WhatsApp chat.
 */
