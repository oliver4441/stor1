...
import { Download, ShoppingBag, Truck, Shield, Star, ArrowRight } from 'lucide-react';

const WELCOME_KEY = 'omix_welcome_seen';
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black">
      ...
      <div className="relative z-10 text-center px-6 max-w-sm mx-auto w-full">
        {/* Logo */}
        <div
          className={`w-24 h-24 rounded-3xl bg-white flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-black/30 transition-all duration-700 ${
            animStep >= 1 ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-75 translate-y-4'
          }`}
        >
          <span className="text-[#ff385c] font-black text-4xl">O</span>
        </div>
        ...
        <button
          ...
          className={`w-full bg-white text-[#ff385c] font-black py-4 rounded-2xl text-lg shadow-xl shadow-black/20 hover:shadow-black/30 active:scale-95 transition-all duration-500 flex items-center justify-center gap-2 ${
