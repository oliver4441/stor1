        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 w-full max-w-lg shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setSelectedCustomer(null)} className="p-2 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-400"><X className="w-5 h-5" /></button>
            </div>

            {/* Stats */}
            <div className="grid grid-cols-3 gap-3 mb-6">
              <div className="p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 text-center">
                <p className="text-lg font-black text-zinc-900 dark:text-white">{selectedCustomer.orders.length}</p>
              ...
              <div className="p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 text-center">
                <p className="text-lg font-black text-zinc-900 dark:text-white">{formatKES(selectedCustomer.orders.length > 0 ? selectedCustomer.totalSpent / selectedCustomer.orders.length : 0)}</p>
            ...
            <div className="mb-6 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50">
              <h4 className="text-sm font-bold text-zinc-700 dark:text-zinc-300 mb-3">Contact Info</h4>
            ...
            {/* Order History */}
            <div>
              <h4 className="text-sm font-bold text-zinc-700 dark:text-zinc-300 mb-3">Order History</h4>
