...
const deliverySteps = [
  {
    ...
    svg: `<svg viewBox="0 0 400 100" xmlns="http://www.w3.org/2000/svg" class="w-full">
      ...
      <rect x="20" y="20" width="80" height="60" rx="6" fill="#71717a"/>
      ...
      <rect x="140" y="20" width="80" height="60" rx="6" fill="#71717a"/>
      ...
      <rect x="260" y="20" width="80" height="60" rx="6" fill="#71717a"/>
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 400 80" xmlns="http://www.w3.org/2000/svg" class="w-full">
      ...
      <rect x="20" y="15" width="120" height="50" rx="6" fill="#71717a"/>
      ...
      <rect x="160" y="15" width="120" height="50" rx="6" fill="#71717a"/>
