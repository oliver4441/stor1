...
export default function AdminOverview() {
  ...
  const stats = [
    ...
    { label: 'Total Orders', value: orders.length, icon: ShoppingBag, color: 'text-zinc-600', bg: 'bg-zinc-500/10', change: `${pendingOrders} pending` },
    ...
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="admin-stat-grid grid grid-cols-2 lg:grid-cols-5 gap-4">
        {stats.map(stat => {
          ...
          return (
            <div key={stat.label} className="fusion-clay-panel fusion-recessed-card p-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Recent Orders */}
        <div className="fusion-clay-panel fusion-recessed-card p-5">
