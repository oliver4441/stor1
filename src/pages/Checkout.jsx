...
export default function CheckoutPage() {
  ...
  if (typeof window !== 'undefined' && localStorage.getItem('omix_offline_mode') === 'true') {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center py-20">
          ...
          <Link to="/" className="inline-flex items-center gap-2 bg-[var(--seasonal-primary,#1a5632)] hover:bg-[#e62e4f] text-white font-semibold px-8 py-4 rounded-xl transition-colors">
            Browse Products
          </Link>
        </div>
      </div>
