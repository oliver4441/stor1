...
function ListingDetails() {
  ...
  // Declared here (before any more JSX returns) to satisfy Rules of Hooks —
  // useMemo must be called on every render, even when loading=true.
  ...
  // Find the fully matched variant object — must be before any JSX return (Rules of Hooks)
