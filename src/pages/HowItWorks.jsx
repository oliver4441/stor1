...
function HowItWorks() {
  ...
  const steps = [
    ...
    },
    {
      ...
      color: 'from-[var(--seasonal-primary,#1a5632)] to-[var(--seasonal-secondary,#14472a)]',
      bg: 'bg-[var(--seasonal-primary,#1a5632)]/5 dark:bg-[var(--seasonal-primary,#1a5632)]/10',
    },
    {
  ...
  return (
    <div data-name="how-it-works-page">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        {/* CTA */}
        <section>
          <div className="bg-gradient-to-br from-[var(--seasonal-primary,#1a5632)] to-[var(--seasonal-secondary,#14472a)] rounded-3xl p-8 md:p-12 text-center">
