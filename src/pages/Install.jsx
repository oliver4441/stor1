...
export default function Install() {
  ...
  const renderInstallButton = () => {
    ...
    if (installState === 'installing') return (
      <div className="flex items-center gap-3 backdrop-blur-xl bg-[#ff385c]/10 border border-[#ff385c]/20 px-8 py-4 rounded-2xl">
    ...
    return (
      <button onClick={handleInstall} className="group relative flex items-center gap-3 bg-gradient-to-r from-[#ff385c] to-[#e03150] text-white px-8 py-4 rounded-2xl font-black text-lg shadow-2xl shadow-[#ff385c]/30 hover:shadow-[#ff385c]/50 transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#ff385c]/20 via-zinc-50 dark:via-zinc-950 to-transparent dark:from-[#ff385c]/10" />
        ...
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-[#ff385c]/20 rounded-full blur-3xl animate-float-slow" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 pt-20 pb-12 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-zinc-900 dark:text-white mb-4 tracking-tight leading-tight">
            <span className="bg-gradient-to-r from-[#ff385c] via-purple-500 to-blue-500 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient-x">
              {t('install.title')}
            </span>
          </h1>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#ff385c]/5 to-transparent dark:via-[#ff385c]/[0.02]" />
        <div className="max-w-6xl mx-auto px-4 relative">
          <div className="text-center mb-12">
            <span className="text-xs font-bold text-[#ff385c] uppercase tracking-[0.2em] bg-[#ff385c]/10 dark:bg-[#ff385c]/20 px-4 py-1.5 rounded-full">Why Install</span>
            ...
            {FEATURES.map((f, idx) => {
              ...
              return (
                <div key={f.title} className="group relative animate-fade-in-up" style={{ animationDelay: `${idx * 100}ms` }}>
                  {/* Glass card */}
                  <div className="relative h-full backdrop-blur-xl bg-white/50 dark:bg-zinc-900/50 border border-white/60 dark:border-zinc-700/50 rounded-2xl p-6 text-center shadow-xl shadow-zinc-900/5 hover:shadow-2xl hover:shadow-zinc-900/10 transition-all duration-500 hover:-translate-y-2 hover:border-[#ff385c]/20">
                    {/* Icon gradient glow */}
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-[#ff385c]/10 via-transparent to-transparent dark:from-[#ff385c]/5" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#ff385c]/10 via-transparent to-transparent dark:from-[#ff385c]/5" />

        {/* Floating orbs */}
        <div className="absolute top-1/2 left-1/4 w-48 h-48 bg-[#ff385c]/20 rounded-full blur-3xl animate-float" />
        ...
        <div className="max-w-2xl mx-auto px-4 text-center relative">
          <div className="backdrop-blur-2xl bg-white/50 dark:bg-zinc-900/50 border border-white/60 dark:border-zinc-700/50 rounded-3xl p-10 md:p-12 shadow-2xl shadow-zinc-900/5">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#ff385c] to-[#e03150] flex items-center justify-center mx-auto mb-6 shadow-xl shadow-[#ff385c]/30">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              {installState !== 'installed' && (
                <button onClick={handleInstall} className="group relative flex items-center gap-2 bg-gradient-to-r from-[#ff385c] to-[#e03150] text-white px-8 py-4 rounded-2xl font-black shadow-2xl shadow-[#ff385c]/25 hover:shadow-[#ff385c]/40 transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden">
                  <div className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity" />
